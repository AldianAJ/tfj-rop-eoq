        ...
        <div class="col-xl-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="apex-charts" data-colors='["--bs-primary", "--bs-warning"]' id="area-chart" dir="ltr">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap">
                        <div>
                            ...
                            <p class="text-success mb-0"><span>0.6 % <i class="mdi mdi-arrow-top-right ms-1"></i></span>
                            </p>
                        </div>
                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="align-self-center overflow-hidden me-auto">
                                                <div>
                                                    <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);"
                                            ...
                                            <div class="dropdown ms-2">
                                                <a class="text-muted font-size-14" href="#" role="button"
                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="align-self-center overflow-hidden me-auto">
                                                <div>
                                                    <h5 class="font-size-14 text-truncate"><a href="javascript: void(0);"
                                                            class="text-dark">Riding bike on road</a></h5>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <div class="py-2">
                                    ...
                                    <div class="progress animated-progess progress-sm">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 69%"
                        ...
                        <ul class="verti-timeline list-unstyled">
                            <li class="event-list active">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <div>
                                            Posted <span class="fw-semibold">Beautiful Day with Friends</span> blog... <a
